...
public class RandomGenerator{
	 ...
	 * @param fileName
	 * @param directory 
	 * @param vertices from 0 to 100
	 * @param dense
	 * @param minCapacity
	 * @param maxCapacity
	 */
	public void BuildGraph(String fileName, String directory, int vertices, double dense, int minCapacity,int maxCapacity)
    {
...
/*	public static void main(String[] args) {
		...
		rg.BuildGraph("g1.txt", ".", 10, 50, 1, 500);
